...
export const EpiUploadSelectSequenceFiles = () => {
  ...
  }, [assemblyProtocolOptionsQuery.isLoading, assemblyProtocolOptionsQuery.options, sequencingProtocolOptionsQuery.isLoading, sequencingProtocolOptionsQuery.options, onAssemblyProtocolChange, onSequencingProtocolChange, t]);
