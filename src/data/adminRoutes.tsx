...
import { CaseTypeColsAdminPage } from '../pages/CaseTypeColsAdminPage';
import { CaseTypeColSetsAdminPage } from '../pages/CaseTypeColSetsAdminPage';
...
export const adminRoutes: MyNonIndexRouteObject[] = [
...

  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.OrganizationCrudCommand, permission_type: PermissionType.R },
      ],
    ...
    children: [
      {
        ...
        handle: {
          ...
          requiredPermissions: [
            { command_name: CommandName.UserCrudCommand, permission_type: PermissionType.R },
            { command_name: CommandName.OrganizationCrudCommand, permission_type: PermissionType.R },
          ],
          requiresUserProfile: true,
          category: ADMIN_PAGE_CATEGORY.USERS_AND_ORGANIZATIONS,
  ...
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.UserInvitationCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.OrganizationCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
      category: ADMIN_PAGE_CATEGORY.USERS_AND_ORGANIZATIONS,
  ...
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.OrganizationAdminPolicyCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.UserCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.OrganizationCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
...

  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.DataCollectionCrudCommand, permission_type: PermissionType.R },
      ],
    },
  },
  {
    ...
    handle: {
      ...
      category: ADMIN_PAGE_CATEGORY.ACCESS_RIGHTS,
      requiredPermissions: [
        { command_name: CommandName.DataCollectionSetCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.DataCollectionCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.DataCollectionSetMemberCrudCommand, permission_type: PermissionType.R },
      ],
    },
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.CaseTypeColSetCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.CaseTypeColSetMemberCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.CaseTypeColCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.ColCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
      category: ADMIN_PAGE_CATEGORY.ACCESS_RIGHTS,
    },
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.OrganizationAccessCasePolicyCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.OrganizationCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.DataCollectionCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.CaseTypeColSetCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.CaseTypeSetCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
      category: ADMIN_PAGE_CATEGORY.ACCESS_RIGHTS,
    },
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.OrganizationShareCasePolicyCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.OrganizationCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.DataCollectionCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
  ...
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.UserAccessCasePolicyCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.UserCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.DataCollectionCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.CaseTypeColSetCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.CaseTypeSetCrudCommand, permission_type: PermissionType.R },
  ...
  // REFERENCE_DATA
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.DimCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
  ...
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.ColCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.DimCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.ConceptSetCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.RegionSetCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.GeneticDistanceProtocolCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
      category: ADMIN_PAGE_CATEGORY.REFERENCE_DATA,
    },
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.DiseaseCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
      category: ADMIN_PAGE_CATEGORY.REFERENCE_DATA,
    },
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.EtiologicalAgentCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
      category: ADMIN_PAGE_CATEGORY.REFERENCE_DATA,
    },
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.EtiologyCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.DiseaseCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.EtiologicalAgentCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
  ...
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.CaseSetStatusCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
      category: ADMIN_PAGE_CATEGORY.REFERENCE_DATA,
    },
  ...
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.CaseTypeColCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.ColCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.TreeAlgorithmCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.CaseTypeCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
      category: ADMIN_PAGE_CATEGORY.REFERENCE_DATA,
  ...
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.CaseTypeSetMemberCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.CaseTypeSetCategoryCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.CaseTypeSetCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.CaseTypeCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
  ...
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.RegionCrudCommand, permission_type: PermissionType.R },
        { command_name: CommandName.RegionSetCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
      category: ADMIN_PAGE_CATEGORY.REFERENCE_DATA,
  ...
  },
  {
    ...
    handle: {
      ...
      requiredPermissions: [
        { command_name: CommandName.RegionSetShapeCrudCommand, permission_type: PermissionType.R },
      ],
      requiresUserProfile: true,
      category: ADMIN_PAGE_CATEGORY.REFERENCE_DATA,
    },
