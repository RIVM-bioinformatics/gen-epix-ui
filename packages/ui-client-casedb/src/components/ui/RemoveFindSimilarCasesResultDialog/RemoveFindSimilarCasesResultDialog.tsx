...
import {
  Stepper,
  STEPPER_DIRECTION,
} from '@gen-epix/ui-core-components/components/Stepper';
...
export interface RemoveFindSimilarCasesResultDialogProps extends WithDialogRenderProps<RemoveFindSimilarCasesResultDialogOpenProps> {
  //
}

export type RemoveFindSimilarCasesResultDialogRefMethods = WithDialogRefMethods<RemoveFindSimilarCasesResultDialogProps, RemoveFindSimilarCasesResultDialogOpenProps>;

export const RemoveFindSimilarCasesResultDialog = withDialog<RemoveFindSimilarCasesResultDialogProps, RemoveFindSimilarCasesResultDialogOpenProps>((
  {
    onActionsChange,
    onClose,
    onTitleChange,
    openProps,
  }: RemoveFindSimilarCasesResultDialogProps,
): ReactElement => {
  ...
  useEffect(() => {
    ...
    actions.push({
      ...TestIdUtil.createAttributes('RemoveFindSimilarCasesResultDialog-closeButton'),
      color: 'primary',
      label: t`Close`,
      onClick: onClose,
      variant: 'outlined',
    ...
    if (findSimilarCasesResults.length !== intermediateFindSimilarCasesResults.length) {
      actions.push({
        ...TestIdUtil.createAttributes('RemoveFindSimilarCasesResultDialog-undoButton'),
        color: 'secondary',
        label: t`Undo`,
    ...
    if (findSimilarCasesResults.length !== intermediateFindSimilarCasesResults.length) {
      actions.push({
        ...TestIdUtil.createAttributes('RemoveFindSimilarCasesResultDialog-applyButton'),
        color: 'secondary',
  ...
  fullWidth: true,
  maxWidth: 'lg',
  testId: 'RemoveFindSimilarCasesResultDialog',
});
