...
export type CaseTypeInfoRegionsProps = {
  readonly completeCaseType: CaseDbCompleteCaseType;
};

export const CaseTypeInfoRegions = ({ completeCaseType }: CaseTypeInfoRegionsProps) => {
  ...
  return (
    <>
      {regionSetIds.map(regionSetId => {
        ...
        const regions = DataService.getInstance().data.regionsByRegionSetId[regionSetId];
        ...
        return (
          ...
          >
            ...
            >
              {DataService.getInstance().data.regionSets[regionSetId].name}
            </AccordionSummary>
            <AccordionDetails>
              <Stack
                sx={{
