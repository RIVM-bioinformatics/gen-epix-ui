...
describe('FindSimilarCasesUtil', () => {
  describe('buildChartIntervals', () => {
    ...
    it('returns empty array for empty data', () => {
      expect(FindSimilarCasesUtil.buildChartIntervals([])).toEqual([]);
    });

    describe('day granularity', () => {
      it('produces a single interval for a single data point', () => {
        const result = FindSimilarCasesUtil.buildChartIntervals([pt('2024-01-15', 3)]);
      ...
      it('startDate and endDate equal the calendar day (yyyy-MM-dd)', () => {
        const result = FindSimilarCasesUtil.buildChartIntervals([pt('2024-03-15', 5)]);
    ...
    describe('result structure invariants', () => {
      ...
      it('total count across all intervals equals sum of input counts', () => {
        ...
        const result = FindSimilarCasesUtil.buildChartIntervals(data);
