...
export const UserInvitationsAdminPage = () => {
  ...
  const customOnRowClick = useCallback((params: TableRowParams<CommonDbUserInvitation>) => {
  ...
  const extraActionsFactory = useCallback((params: TableRowParams<CommonDbUserInvitation>) => {
    return [
      (
        <MenuItem
          key={'custom-action-1'}
