...
export class DemoConfigUtil {
  public static createConfig(): ConfigBase {
    ...
    const config: ConfigBase = {
      abacApi: {} as ConfigBase['abacApi'],
      api: {} as ConfigBase['api'],
      // eslint-disable-next-line @typescript-eslint/naming-convention
      ApplicationHeader,
      applicationName: 'Gen-EpiX',
      authApi: {} as ConfigBase['authApi'],
      consentDialog: {
        // eslint-disable-next-line @typescript-eslint/naming-convention
      ...
      organizationApi: {} as ConfigBase['organizationApi'],
      outages: {
      ...
      routerManager: null as unknown as ConfigBase['routerManager'],
      spinner: {
        DEFAULT_CIRCULAR_PROGRESS_SIZE: 40,
        DEFAULT_TAKING_LONGER_TIMEOUT_MS: 8000,
      },
      systemApi: {} as ConfigBase['systemApi'],
      table: {
