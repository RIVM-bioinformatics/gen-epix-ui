...
export type CasesAlreadyInCaseSetWarningCaseSetLinkProps = {
  readonly caseSet: CaseDbCaseSet;
};

export const CasesAlreadyInCaseSetWarningCaseSetLink = ({ caseSet }: CasesAlreadyInCaseSetWarningCaseSetLinkProps) => {
