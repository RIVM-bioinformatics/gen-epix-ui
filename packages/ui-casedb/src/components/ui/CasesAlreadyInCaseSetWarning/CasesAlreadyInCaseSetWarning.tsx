...
export type CasesAlreadyInCaseSetWarningProps = {
  readonly cases: CaseDbCase[];
};

export const CasesAlreadyInCaseSetWarning = ({ cases }: CasesAlreadyInCaseSetWarningProps) => {
                  ...
                  <TableRow key={caseItem.id}>
                    ...
                    >
                      {caseItemCaseSets.sort((a, b) => a.name.localeCompare(b.name)).map(caseItemCaseSet => (
                        <CasesAlreadyInCaseSetWarningCaseSetLink
