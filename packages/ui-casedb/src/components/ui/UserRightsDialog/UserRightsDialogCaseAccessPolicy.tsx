...
export type UserRightsDialogCaseAccessPolicyProps = {
...
export const UserRightsDialogCaseAccessPolicy = ({ user }: UserRightsDialogCaseAccessPolicyProps) => {
  ...
  const tableStore = useMemo(() => createTableStore<AccessCasePolity>({
    ...
    storageNamePostFix: 'UserRightsDialogCaseAccessPolicy-Table',
    storageVersion: 1,
  }), []);
