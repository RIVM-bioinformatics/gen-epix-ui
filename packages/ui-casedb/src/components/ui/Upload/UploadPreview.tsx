...
import { UploadCaseResultTable } from './UploadCaseResultTable';
import { UploadPreviewNavigation } from './UploadPreviewNavigation';

export type UploadPreviewProps = {
  readonly caseTypeId: string;
};

export const UploadPreview = withEpiCompleteCaseTypeLoader<UploadPreviewProps>(({ caseTypeId }) => {
