...
import { CaseTypeInfoVariableDetails } from './CaseTypeInfoVariableDetails';

export type CaseTypeInfoValuesProps = {
  readonly completeCaseType: CaseDbCompleteCaseType;
};

export const CaseTypeInfoValues = ({ completeCaseType }: CaseTypeInfoValuesProps) => {
  return (
    <>
