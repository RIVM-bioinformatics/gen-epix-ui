...
import { CaseSetSharingInfo } from './CaseSetSharingInfo';
import { CaseSetForm } from './CaseSetForm';
import { CaseSetContent } from './CaseSetContent';


export interface CaseSetInfoDialogOpenProps {
  readonly caseSetId: string;
  readonly caseTypeId: string;
}

export interface CaseSetInfoDialogProps extends WithDialogRenderProps<CaseSetInfoDialogOpenProps> {
  readonly showNavigationButton?: boolean;
}

export type CaseSetInfoDialogRefMethods = WithDialogRefMethods<CaseSetInfoDialogProps, CaseSetInfoDialogOpenProps>;

export const CaseSetInfoDialog = withDialog<CaseSetInfoDialogProps, CaseSetInfoDialogOpenProps>((
  {
    onActionsChange,
    onClose,
    onPermalinkChange,
  ...
  useEffect(() => {
    ...
    if (isEditingCaseSetContent || isEditingDataCollections) {
      actions.push({
        ...TestIdUtil.createAttributes('CaseSetInfoDialog-goBackButton'),
        color: 'primary',
        disabled: isSaving,
        label: t`Go back`,
    ...
    if (isEditingCaseSetContent) {
      actions.push(
        {
          ...TestIdUtil.createAttributes('CaseSetInfoDialog-saveButton'),
          color: 'secondary',
          disabled: isSaving,
          form: valuesFormId,
          label: t`Save`,
      ...
      actions.push(
        ...
        {
          ...TestIdUtil.createAttributes('CaseSetInfoDialog-editDataCollectionsButton'),
          color: 'primary',
          disabled: !canShare,
          label: t`Share`,
        ...
        {
          ...TestIdUtil.createAttributes('CaseSetInfoDialog-editCaseContentButton'),
          color: 'primary',
          disabled: !canEdit,
          label: t`Edit`,
      ...
      if (showNavigationButton) {
        actions.push(
          {
            ...TestIdUtil.createAttributes('CaseSetInfoDialog-goToEvent'),
            autoFocus: true,
            color: 'secondary',
            label: t`Go to event`,
