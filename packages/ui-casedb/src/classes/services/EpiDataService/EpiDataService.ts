...
export class EpiDataService {
  private static __instance: EpiDataService;
  ...
  public static getInstance(): EpiDataService {
    EpiDataService.__instance = HmrUtil.getHmrSingleton('epiDataService', EpiDataService.__instance, () => new EpiDataService());
    return EpiDataService.__instance;
  }
