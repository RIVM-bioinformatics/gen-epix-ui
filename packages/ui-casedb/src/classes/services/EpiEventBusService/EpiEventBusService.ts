...
export class EpiEventBusService extends EventBusAbstract<EpiEvent> {
  private static __instance: EpiEventBusService;

  private constructor() {
    super();
  }

  public static getInstance(): EpiEventBusService {
    EpiEventBusService.__instance = HmrUtil.getHmrSingleton('epiEventBusService', EpiEventBusService.__instance, () => new EpiEventBusService());
    return EpiEventBusService.__instance;
  }
