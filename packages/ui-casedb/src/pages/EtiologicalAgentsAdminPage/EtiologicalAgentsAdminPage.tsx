...
export const EtiologicalAgentsAdminPage = () => {
  ...
  const fetchAll = useCallback(async (signal: AbortSignal) => {
    return (await CaseDbOntologyApi.getInstance().etiologicalAgentsGetAll(null, null, { signal }))?.data;
  }, []);
  ...
  return (
    <CrudPage<FormFields, CaseDbEtiologicalAgent, CaseDbEtiologicalAgent, CASEDB_QUERY_KEY, CaseDbApiPermission>
